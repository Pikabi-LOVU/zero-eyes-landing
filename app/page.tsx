          ...
          <div className="bg-gradient-to-br from-orange-50 to-blue-50 rounded-2xl p-8 mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 bg-white rounded-xl p-4 shadow-sm">
                ...
                <a
                  href="https://qanda.onelink.me/c661/zeroeyes"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-2 bg-[#5856D6] text-white rounded-lg text-sm font-medium hover:bg-[#4745C5] transition-colors flex-shrink-0"
                >
                  앱 다운로드
                </a>
              </div>
